...
bool interfaces__msg__water_track__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interfaces.msg._water_track.WaterTrack", full_classname_dest, 38) == 0);
  }
  interfaces__msg__WaterTrack * ros_message = _ros_message;
  {  // system_timestamp
...
{
  /* NOTE(esteve): Call constructor of WaterTrack */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces.msg._water_track");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "WaterTrack");
