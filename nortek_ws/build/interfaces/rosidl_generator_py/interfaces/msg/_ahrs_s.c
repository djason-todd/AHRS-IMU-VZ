...
bool interfaces__msg__ahrs__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interfaces.msg._ahrs.AHRS", full_classname_dest, 25) == 0);
  }
  interfaces__msg__AHRS * ros_message = _ros_message;
  {  // system_timestamp
...
PyObject * interfaces__msg__ahrs__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces.msg._ahrs");
