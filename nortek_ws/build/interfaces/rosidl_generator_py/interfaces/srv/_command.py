...
class Metaclass_Command(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from interfaces.srv import _command
...
class Command(metaclass=Metaclass_Command):
    from interfaces.srv._command import Command_Request as Request
    from interfaces.srv._command import Command_Response as Response
