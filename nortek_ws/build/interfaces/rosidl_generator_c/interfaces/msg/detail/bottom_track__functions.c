...
bool
interfaces__msg__BottomTrack__init(interfaces__msg__BottomTrack * msg)
{
  if (!msg) {
    return false;
  }
  ...
  if (!builtin_interfaces__msg__Time__init(&msg->system_timestamp)) {
    interfaces__msg__BottomTrack__fini(msg);
    return false;
  }
  // posix_time
  // timestamp
...
void
interfaces__msg__BottomTrack__fini(interfaces__msg__BottomTrack * msg)
{
  if (!msg) {
    return;
  }
...
bool
interfaces__msg__BottomTrack__are_equal(const interfaces__msg__BottomTrack * lhs, const interfaces__msg__BottomTrack * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
interfaces__msg__BottomTrack__copy(
  const interfaces__msg__BottomTrack * input,
  interfaces__msg__BottomTrack * output)
{
  if (!input || !output) {
    return false;
  }
...
interfaces__msg__BottomTrack *
interfaces__msg__BottomTrack__create()
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  interfaces__msg__BottomTrack * msg = (interfaces__msg__BottomTrack *)allocator.allocate(sizeof(interfaces__msg__BottomTrack), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(interfaces__msg__BottomTrack));
  bool success = interfaces__msg__BottomTrack__init(msg);
  if (!success) {
...
void
interfaces__msg__BottomTrack__destroy(interfaces__msg__BottomTrack * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    interfaces__msg__BottomTrack__fini(msg);
...
bool
interfaces__msg__BottomTrack__Sequence__init(interfaces__msg__BottomTrack__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  interfaces__msg__BottomTrack * data = NULL;

  if (size) {
    data = (interfaces__msg__BottomTrack *)allocator.zero_allocate(size, sizeof(interfaces__msg__BottomTrack), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = interfaces__msg__BottomTrack__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        interfaces__msg__BottomTrack__fini(&data[i - 1]);
      }
...
void
interfaces__msg__BottomTrack__Sequence__fini(interfaces__msg__BottomTrack__Sequence * array)
{
  if (!array) {
    return;
  }
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      interfaces__msg__BottomTrack__fini(&array->data[i]);
    }
...
interfaces__msg__BottomTrack__Sequence *
interfaces__msg__BottomTrack__Sequence__create(size_t size)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  interfaces__msg__BottomTrack__Sequence * array = (interfaces__msg__BottomTrack__Sequence *)allocator.allocate(sizeof(interfaces__msg__BottomTrack__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = interfaces__msg__BottomTrack__Sequence__init(array, size);
  if (!success) {
...
void
interfaces__msg__BottomTrack__Sequence__destroy(interfaces__msg__BottomTrack__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    interfaces__msg__BottomTrack__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool
interfaces__msg__BottomTrack__Sequence__are_equal(const interfaces__msg__BottomTrack__Sequence * lhs, const interfaces__msg__BottomTrack__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!interfaces__msg__BottomTrack__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
interfaces__msg__BottomTrack__Sequence__copy(
  const interfaces__msg__BottomTrack__Sequence * input,
  interfaces__msg__BottomTrack__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(interfaces__msg__BottomTrack);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    interfaces__msg__BottomTrack * data =
      (interfaces__msg__BottomTrack *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!interfaces__msg__BottomTrack__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          interfaces__msg__BottomTrack__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!interfaces__msg__BottomTrack__copy(
