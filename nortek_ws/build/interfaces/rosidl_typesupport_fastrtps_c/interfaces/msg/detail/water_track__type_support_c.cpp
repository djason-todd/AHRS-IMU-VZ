...
#include "interfaces/msg/detail/water_track__rosidl_typesupport_fastrtps_c.h"
...
using _WaterTrack__ros_msg_type = interfaces__msg__WaterTrack;

static bool _WaterTrack__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _WaterTrack__ros_msg_type * ros_message = static_cast<const _WaterTrack__ros_msg_type *>(untyped_ros_message);
...
static bool _WaterTrack__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _WaterTrack__ros_msg_type * ros_message = static_cast<_WaterTrack__ros_msg_type *>(untyped_ros_message);
  // Field name: system_timestamp
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_interfaces__msg__WaterTrack(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _WaterTrack__ros_msg_type * ros_message = static_cast<const _WaterTrack__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _WaterTrack__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interfaces__msg__WaterTrack(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t max_serialized_size_interfaces__msg__WaterTrack(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces__msg__WaterTrack;
    is_plain =
      (
...
static size_t _WaterTrack__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_interfaces__msg__WaterTrack(
...
static message_type_support_callbacks_t __callbacks_WaterTrack = {
  "interfaces::msg",
  "WaterTrack",
  _WaterTrack__cdr_serialize,
  _WaterTrack__cdr_deserialize,
  _WaterTrack__get_serialized_size,
  _WaterTrack__max_serialized_size
};

static rosidl_message_type_support_t _WaterTrack__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_WaterTrack,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces, msg, WaterTrack)() {
  return &_WaterTrack__type_support;
}
