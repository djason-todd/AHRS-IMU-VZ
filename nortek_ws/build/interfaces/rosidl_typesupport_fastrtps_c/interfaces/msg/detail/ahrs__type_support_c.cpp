...
#include "interfaces/msg/detail/ahrs__rosidl_typesupport_fastrtps_c.h"
...
using _AHRS__ros_msg_type = interfaces__msg__AHRS;
...
size_t get_serialized_size_interfaces__msg__AHRS(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _AHRS__ros_msg_type * ros_message = static_cast<const _AHRS__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _AHRS__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interfaces__msg__AHRS(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t max_serialized_size_interfaces__msg__AHRS(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces__msg__AHRS;
    is_plain =
      (
...
static size_t _AHRS__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interfaces__msg__AHRS(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces, msg, AHRS)() {
