...
#include "interfaces/msg/detail/altimeter__rosidl_typesupport_fastrtps_c.h"
...
using _Altimeter__ros_msg_type = interfaces__msg__Altimeter;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: altimeter_distance_valid
  {
    cdr << (ros_message->altimeter_distance_valid ? true : false);
  }

  // Field name: altimeter_quality_valid
  {
  ...
  // Field name: altimeter_distance
  {
    cdr << ros_message->altimeter_distance;
  }

  // Field name: altimeter_quality
  {
...
size_t get_serialized_size_interfaces__msg__Altimeter(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Altimeter__ros_msg_type * ros_message = static_cast<const _Altimeter__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Altimeter__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interfaces__msg__Altimeter(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t max_serialized_size_interfaces__msg__Altimeter(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces__msg__Altimeter;
    is_plain =
      (
...
static size_t _Altimeter__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interfaces__msg__Altimeter(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces, msg, Altimeter)() {
