...
#include "interfaces/msg/detail/ahrs__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces::msg::AHRS & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::msg::AHRS & ros_message)
{
  // Member: system_timestamp
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces::msg::AHRS;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interfaces::msg::AHRS *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::msg::AHRS *>(
    untyped_ros_message);
...
static size_t _AHRS__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_AHRS(full_bounded, is_plain, 0);
...
get_message_type_support_handle<interfaces::msg::AHRS>()
{
  return &interfaces::msg::typesupport_fastrtps_cpp::_AHRS__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, msg, AHRS)() {
  return &interfaces::msg::typesupport_fastrtps_cpp::_AHRS__handle;
}
