...
#include "interfaces/msg/detail/water_track__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces::msg::WaterTrack & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::msg::WaterTrack & ros_message)
{
  // Member: system_timestamp
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_interfaces
max_serialized_size_WaterTrack(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces::msg::WaterTrack;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interfaces::msg::WaterTrack *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::msg::WaterTrack *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _WaterTrack__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const interfaces::msg::WaterTrack *>(
...
static size_t _WaterTrack__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_WaterTrack(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _WaterTrack__callbacks = {
  "interfaces::msg",
  "WaterTrack",
...
static rosidl_message_type_support_t _WaterTrack__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_WaterTrack__callbacks,
...
{
  return &interfaces::msg::typesupport_fastrtps_cpp::_WaterTrack__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, msg, WaterTrack)() {
  return &interfaces::msg::typesupport_fastrtps_cpp::_WaterTrack__handle;
}
