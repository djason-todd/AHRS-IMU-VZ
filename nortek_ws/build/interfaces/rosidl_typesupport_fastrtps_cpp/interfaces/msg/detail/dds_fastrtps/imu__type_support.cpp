...
#include "interfaces/msg/detail/imu__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces::msg::IMU & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::msg::IMU & ros_message)
{
  // Member: system_timestamp
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces::msg::IMU;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interfaces::msg::IMU *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::msg::IMU *>(
    untyped_ros_message);
...
{
  return &interfaces::msg::typesupport_fastrtps_cpp::_IMU__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, msg, IMU)() {
  return &interfaces::msg::typesupport_fastrtps_cpp::_IMU__handle;
}
