...
#include "interfaces/msg/detail/ins__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces::msg::INS;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interfaces::msg::INS *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::msg::INS *>(
    untyped_ros_message);
...
{
  return &interfaces::msg::typesupport_fastrtps_cpp::_INS__handle;
}
