...
{
  new (message_memory) interfaces::srv::Stop_Request(_init);
}

void Stop_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<interfaces::srv::Stop_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Stop_Request_message_member_array[1] = {
  {
    ...
    offsetof(interfaces::srv::Stop_Request, structure_needs_at_least_one_member),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Stop_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(interfaces::srv::Stop_Request),
...
{
  return &::interfaces::srv::rosidl_typesupport_introspection_cpp::Stop_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interfaces, srv, Stop_Request)() {
  return &::interfaces::srv::rosidl_typesupport_introspection_cpp::Stop_Request_message_type_support_handle;
}
...
void Stop_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) interfaces::srv::Stop_Response(_init);
}

void Stop_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<interfaces::srv::Stop_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Stop_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(interfaces::srv::Stop_Response, reply),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Stop_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(interfaces::srv::Stop_Response),
...
{
  return &::interfaces::srv::rosidl_typesupport_introspection_cpp::Stop_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interfaces, srv, Stop_Response)() {
  return &::interfaces::srv::rosidl_typesupport_introspection_cpp::Stop_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers Stop_service_members = {
  ...
  // see get_service_type_support_handle<interfaces::srv::Stop>()
...
get_service_type_support_handle<interfaces::srv::Stop>()
{
  ...
  auto service_type_support =
    &::interfaces::srv::rosidl_typesupport_introspection_cpp::Stop_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interfaces, srv, Stop)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<interfaces::srv::Stop>();
}
