...
#ifndef INTERFACES__MSG__DETAIL__WATER_TRACK__STRUCT_HPP_
#define INTERFACES__MSG__DETAIL__WATER_TRACK__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__interfaces__msg__WaterTrack __attribute__((deprecated))
#else
# define DEPRECATED__interfaces__msg__WaterTrack __declspec(deprecated)
#endif
...
struct WaterTrack_
{
  using Type = WaterTrack_<ContainerAllocator>;

  explicit WaterTrack_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  ...
  explicit WaterTrack_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  ...
  // pointer types
  using RawPtr =
    interfaces::msg::WaterTrack_<ContainerAllocator> *;
  using ConstRawPtr =
    const interfaces::msg::WaterTrack_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<interfaces::msg::WaterTrack_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<interfaces::msg::WaterTrack_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      interfaces::msg::WaterTrack_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<interfaces::msg::WaterTrack_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<interfaces::msg::WaterTrack_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<interfaces::msg::WaterTrack_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<interfaces::msg::WaterTrack_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__interfaces__msg__WaterTrack
    std::shared_ptr<interfaces::msg::WaterTrack_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__interfaces__msg__WaterTrack
    std::shared_ptr<interfaces::msg::WaterTrack_<ContainerAllocator> const>
  ...
  bool operator==(const WaterTrack_ & other) const
  {
...
using WaterTrack =
  interfaces::msg::WaterTrack_<std::allocator<void>>;
...
#endif  // INTERFACES__MSG__DETAIL__WATER_TRACK__STRUCT_HPP_
