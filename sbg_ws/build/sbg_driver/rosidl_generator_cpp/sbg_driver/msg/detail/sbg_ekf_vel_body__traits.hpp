...
#ifndef SBG_DRIVER__MSG__DETAIL__SBG_EKF_VEL_BODY__TRAITS_HPP_
#define SBG_DRIVER__MSG__DETAIL__SBG_EKF_VEL_BODY__TRAITS_HPP_
...
inline std::string to_yaml(const SbgEkfVelBody & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const sbg_driver::msg::SbgEkfVelBody & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const sbg_driver::msg::SbgEkfVelBody & msg)
{
  return sbg_driver::msg::to_yaml(msg);
}

template<>
inline const char * data_type<sbg_driver::msg::SbgEkfVelBody>()
{
  return "sbg_driver::msg::SbgEkfVelBody";
}

template<>
inline const char * name<sbg_driver::msg::SbgEkfVelBody>()
{
  return "sbg_driver/msg/SbgEkfVelBody";
}

template<>
struct has_fixed_size<sbg_driver::msg::SbgEkfVelBody>
...
template<>
struct has_bounded_size<sbg_driver::msg::SbgEkfVelBody>
...
template<>
struct is_message<sbg_driver::msg::SbgEkfVelBody>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // SBG_DRIVER__MSG__DETAIL__SBG_EKF_VEL_BODY__TRAITS_HPP_
