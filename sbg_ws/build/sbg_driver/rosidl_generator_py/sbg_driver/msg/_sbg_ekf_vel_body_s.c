...
bool sbg_driver__msg__sbg_ekf_vel_body__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sbg_driver.msg._sbg_ekf_vel_body.SbgEkfVelBody", full_classname_dest, 46) == 0);
  }
  sbg_driver__msg__SbgEkfVelBody * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of SbgEkfVelBody */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("sbg_driver.msg._sbg_ekf_vel_body");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SbgEkfVelBody");
