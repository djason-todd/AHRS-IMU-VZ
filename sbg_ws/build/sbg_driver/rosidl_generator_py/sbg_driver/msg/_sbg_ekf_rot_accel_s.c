...
bool sbg_driver__msg__sbg_ekf_rot_accel__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sbg_driver.msg._sbg_ekf_rot_accel.SbgEkfRotAccel", full_classname_dest, 48) == 0);
  }
  sbg_driver__msg__SbgEkfRotAccel * ros_message = _ros_message;
  {  // header
  ...
  {  // rate
    ...
    if (!geometry_msgs__msg__vector3__convert_from_py(field, &ros_message->rate)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of SbgEkfRotAccel */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("sbg_driver.msg._sbg_ekf_rot_accel");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SbgEkfRotAccel");
  ...
  {  // rate
    PyObject * field = NULL;
    field = geometry_msgs__msg__vector3__convert_to_py(&ros_message->rate);
    if (!field) {
      return NULL;
    }
    {
